...
const myWayItems = [
  {
    ...
    text: `Меня всегда инетересовало как устроены программы и за счёт чего они работают. Начинал я свой путь 
с обычной верстки HTML CSS. В теченииэтого года я усердно старался верстать готовые шаблоны
и практиковался.`,
  },
  {
    diretion: "right",
